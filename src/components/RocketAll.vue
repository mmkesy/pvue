...
<template>
      ...
      <main class="mx-auto max-w-4xl">
        ...
        >
          ...
          <img class="w-1/2" src="/src/img/rocketdab.png" alt="Rocket Dab" />
        </section>
        ...
        >
          ...
          >
            ...
            >
              <img src="/src/img/rocketman.png" alt="Explorer" class="mb-6 w-1/2" />
        ...
        <section
          id="testimonials"
          class="widescreen:section-min-height tallscreen:section-min-height my-12 scroll-mt-20 p-6  outline-dotted"
        >
          <h2
            class="mb-6 text-center text-4xl font-bold text-slate-900 dark:text-white sm:text-5xl outline-dotted"
          >
            Testimonials
          </h2>
          <figure class="my-12">
            <blockquote
              class="relative rounded-3xl bg-gradient-to-b from-teal-400 to-teal-700 py-12 pl-14 pr-8 dark:bg-black sm:shadow-2xl"
            >
              <p
      ...
      <footer id="footer" class="bg-teal-700 text-xl text-white">
        ...
        >
          <address>
            ...
            Email:
            <a href="mailto:inquiries@acmerockets.com">Inquires@AcmeRockets.com</a
            ><br />
